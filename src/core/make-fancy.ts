...
type MoveState = Record<MoveStyleProps, string>;

type ResizeStyleProps = "width" | "height";
type ResizeState = Record<ResizeStyleProps, string>;
...
export function makeMovable(element: HTMLElement, {handle, onStop: _onStop, onMove, state}: MovableOpts = {}) {
